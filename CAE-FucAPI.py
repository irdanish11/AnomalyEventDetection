...
decoder = Conv2DTranspose(filters = 1, kernel_size = (5, 5), strides = 4, padding = 'same', activation = 'relu', kernel_initializer = 'RandomNormal', name = 'Deconvolutional_Layer')(dec_conv_lstm)
